...
export const ABOUT_TECHNOLOGIES = ["n8n", "React", "Node.js", "Next.js", "Convex", "Supabase", "Neon", "MongoDB", "Mongoose", "PostgreSQL", "Express.js", "TypeScript", "Redux", "Redis", "Socket.io", "Shadcn-UI", "Clerk", "OAuth", "Webhooks", "Make.com", "Zapier", "OpenAI", "Anthropic", "LLMs", "Chatbots", "AWS", "Google Cloud", "Docker", "CI/CD", "Jenkins", "Concourse", "Kafka", "Cypress", "Cucumber", "Puppeteer", "Lightning.js", "Stripe", "Slack", "ClickUp", "Zoho", "Typeform", "Airtable", "JotForm", "Notion", "Tally.so", "S3", "Lambda", "EC2", "CloudWatch", "AG-Grid"];
